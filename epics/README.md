...
| [08](EPIC-08-app-shell-and-navigation.md) | App shell, navigation and the global dialogs | 03, 07 | 3 — `dialog.discard`, `dialog.confirmDelete`, `dialog.snooze`, the three that belong to no feature | 9 h · ~9 weeks |
