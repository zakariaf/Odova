...
class HomeState {
  ...
  /// The civil date everything on this screen is measured against.
  ///
  /// Carried so a widget can count from the SAME day the model did. Null when
  /// the device clock cannot name one.
