...
class VehicleRepository {
  ...
  VehiclesCompanion _companionFor(Vehicle vehicle) => VehiclesCompanion.insert(
    ...
    purchaseOdometerM: Value(vehicle.purchaseOdometer?.metres),
    purchasePriceMinor: Value(vehicle.purchasePrice?.amountMinor),
    purchasePriceCurrency: Value(vehicle.purchasePrice?.currency.code),
    status: vehicle.status.wire,
    soldOn: Value(vehicle.soldOn),
    soldPriceMinor: Value(vehicle.soldPrice?.amountMinor),
    soldPriceCurrency: Value(vehicle.soldPrice?.currency.code),
    expectedAnnualM: Value(vehicle.expectedAnnual?.metres),
    ...
    noticeDistanceM: Value(vehicle.noticeDistance?.metres),
