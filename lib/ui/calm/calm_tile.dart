...
//
// Value and label arrive already formatted. This widget never formats a
// number —
...
/// A three-across statistic tile.
///
/// Non-interactive by design: a tile is a read-out, and giving it a tap target
/// invites the "everything is a button" screen Calm rejects.
class CalmTile extends StatelessWidget {
  /// Creates a tile from an already-formatted value and label.
  const CalmTile({
    required this.value,
    required this.label,
    super.key,
