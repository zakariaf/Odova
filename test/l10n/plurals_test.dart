...
String _render(AppLocalizations l10n, String key, int n, String nText) =>
    switch (key) {
      ...
      'settingsVehicleCount' => l10n.settingsVehicleCount(n, nText),
      ...
      // §11's two delete bodies that carry a count. The count is the only
      // thing that varies in either, so it is the axis a few/many mistake
      // shows up against.
