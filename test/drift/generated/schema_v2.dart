...
class ScheduledNotifications extends Table
    with TableInfo<ScheduledNotifications, ScheduledNotificationsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  ScheduledNotificationsData map(
    ...
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ScheduledNotificationsData(
...
class ScheduledNotificationsData extends DataClass
    implements Insertable<ScheduledNotificationsData> {
  final String key;
  final int osId;
  final String vehicleId;
  ...
  factory ScheduledNotificationsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ScheduledNotificationsData copyWith({
    String? key,
    int? osId,
    String? vehicleId,
  ...
  ScheduledNotificationsData copyWithCompanion(
  ...
  @override
  String toString() {
    return (StringBuffer('ScheduledNotificationsData(')
          ..write('key: $key, ')
          ..write('osId: $osId, ')
          ..write('vehicleId: $vehicleId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ScheduledNotificationsData &&
          other.key == this.key &&
...
class ScheduledNotificationsCompanion
    extends UpdateCompanion<ScheduledNotificationsData> {
  ...
  ScheduledNotificationsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       state = Value(state),
       updatedAtUtcMs = Value(updatedAtUtcMs);
  static Insertable<ScheduledNotificationsData> custom({
